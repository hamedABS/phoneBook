...
public class ContactPage extends javax.swing.JPanel {
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        int column =1;
        int id ;
        id = Integer.parseInt((String) table.getModel().getValueAt(row,column));
        System.out.println(id);
        Client client = Client.create();
        WebResource webResource = client.resource(String.format("http://%s:8080/api/Contact/{%d}",serverIp,id));
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        contact.setId(Integer.parseInt((String)rowContent.get(0)));
